import { w as T, i as v, r as y, n as h, t as f, y as E, x as n, z as Le, v as Te, A as Oe, B as Ie, C as je, D as qe, E as He, G as I, H as Y, I as De, a as Ue, F as Be } from "./copilot-tF9CaZ8e.js";
import { B as Fe } from "./base-panel-__PMv33m.js";
var H = /* @__PURE__ */ ((t) => (t.disabled = "disabled", t.enabled = "enabled", t.missing_theme = "missing_theme", t))(H || {}), u = /* @__PURE__ */ ((t) => (t.local = "local", t.global = "global", t))(u || {});
function Q(t, e) {
  return `${t}|${e}`;
}
class b {
...
let j, me = "";
function Re(t) {
  j || (j = new CSSStyleSheet(), document.adoptedStyleSheets = [...document.adoptedStyleSheets, j]), me += t.cssText, j.replaceSync(me);
}
const Me = v`
  .editor-row {
    display: flex;
...
async function Ke(t) {
  ...
  try {
    t.elements.forEach((o) => {
      ...
      const a = r.match(ge);
      r = r.replace(ge, "");
      const l = r.match(fe), c = r.replace(fe, "");
  ...
  push(e, s, i) {
    ...
    if (p.index++, p.entries = p.entries.slice(0, p.index), p.entries.push(o), s)
      try {
        ...
        console.error("Execute history entry failed", r);
      }
...
var Ye = Object.defineProperty, Qe = Object.getOwnPropertyDescriptor, x = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? Qe(e, s) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (o = (i ? a(e, s, o) : a(o)) || o);
  return i && o && Ye(e, s, o), o;
};
class et extends CustomEvent {
  constructor(e, s, i) {
...
class g extends E {
  ...
  dispatchChange(e) {
    this.dispatchEvent(new et(this.elementMetadata, this.propertyMetadata, e));
  }
}
x([
  h({})
...
let U = class extends E {
  ...
  render() {
    return n`
      ...
      <button @click=${this.handleClearClick}>${Le.cross}</button>
    `;
  }
  handleInputChange(t) {
    const e = t.target;
...
x([
  h({})
], U.prototype, "showClearButton", 2);
U = x([
  f("copilot-theme-text-input")
], U);
var tt = Object.defineProperty, st = Object.getOwnPropertyDescriptor, J = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? st(e, s) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (o = (i ? a(e, s, o) : a(o)) || o);
  return i && o && tt(e, s, o), o;
};
...
let V = class extends E {
  ...
  handleInputChange(t) {
    ...
    this.invalid = !this.editedClassName.match(e), !this.invalid && this.editedClassName !== this.className && this.dispatchEvent(new ot(this.editedClassName));
  }
};
J([
  h({})
...
var it = Object.defineProperty, rt = Object.getOwnPropertyDescriptor, X = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? rt(e, s) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (o = (i ? a(e, s, o) : a(o)) || o);
  return i && o && it(e, s, o), o;
};
class at extends CustomEvent {
  constructor(e) {
...
let z = class extends E {
  ...
  handleValueChange(t) {
    ...
    e !== this.value && this.dispatchEvent(new at(e));
  }
};
X([
  h({})
...
var nt = Object.defineProperty, lt = Object.getOwnPropertyDescriptor, ct = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? lt(e, s) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (o = (i ? a(e, s, o) : a(o)) || o);
  return i && o && nt(e, s, o), o;
};
...
var dt = Object.defineProperty, ht = Object.getOwnPropertyDescriptor, pt = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? ht(e, s) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (o = (i ? a(e, s, o) : a(o)) || o);
...
var mt = Object.defineProperty, vt = Object.getOwnPropertyDescriptor, le = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? vt(e, s) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (o = (i ? a(e, s, o) : a(o)) || o);
  return i && o && mt(e, s, o), o;
};
let B = class extends g {
  constructor() {
    super(), this.selectedPresetIndex = -1, this.presets = new D();
  }
  static get styles() {
    return [
      g.styles,
  ...
  update(t) {
    t.has("propertyMetadata") && (this.presets = new D(this.propertyMetadata)), super.update(t);
  }
  renderEditor() {
    var s;
    const t = {
...
const A = (t, e = 0, s = 1) => t > s ? s : t < e ? e : t, m = (t, e = 0, s = Math.pow(10, e)) => Math.round(s * t) / s, Ae = ({ h: t, s: e, v: s, a: i }) => {
  const o = (200 - e) * s / 100;
  return {
    h: m(t),
  ...
  const { h: e, s, l: i } = Ae(t);
  return `hsl(${e}, ${s}%, ${i}%)`;
}, ee = (t) => {
  const { h: e, s, l: i, a: o } = Ae(t);
  return `hsla(${e}, ${s}%, ${i}%, ${o})`;
}, gt = ({ h: t, s: e, v: s, a: i }) => {
  ...
  for (const s in t)
    if (t[s] !== e[s])
      return !1;
  return !0;
}, xt = (t, e) => t.replace(/\s/g, "") === e.replace(/\s/g, ""), _e = {}, Ve = (t) => {
  let e = _e[t];
...
let R = !1;
const ae = (t) => "touches" in t, Ct = (t) => R && !ae(t) ? !1 : (R || (R = ae(t)), !0), $e = (t, e) => {
  const s = ae(e) ? e.touches[0] : e, i = t.el.getBoundingClientRect();
  ce(t.el, "move", t.getMove({
    x: A((s.pageX - (i.left + window.pageXOffset)) / i.width),
    y: A((s.pageY - (i.top + window.pageYOffset)) / i.height)
  }));
}, _t = (t, e) => {
  const s = e.keyCode;
  s > 40 || t.xy && s < 37 || s < 33 || (e.preventDefault(), ce(t.el, "move", t.getMove({
...
class de {
  constructor(e, s, i, o) {
    const r = Ve(`<div role="slider" tabindex="0" part="${s}" ${i}><div part="${s}-pointer"></div></div>`);
  ...
  handleEvent(e) {
    switch (e.type) {
      case "mousedown":
      case "touchstart":
        if (e.preventDefault(), !Ct(e) || !R && e.button != 0)
          return;
...
class kt extends de {
  ...
  update(e) {
    this.hsva = e, this.style([
      ...
      {
        "background-color": re({ h: e.h, s: 100, v: 100, a: 1 })
      }
...
const St = ':host{display:flex;flex-direction:column;position:relative;width:200px;height:200px;user-select:none;-webkit-user-select:none;cursor:default}:host([hidden]){display:none!important}[role=slider]{position:relative;touch-action:none;user-select:none;-webkit-user-select:none;outline:0}[role=slider]:last-child{border-radius:0 0 8px 8px}[part$=pointer]{position:absolute;z-index:1;box-sizing:border-box;width:28px;height:28px;display:flex;place-content:center center;transform:translate(-50%,-50%);background-color:#fff;border:2px solid #fff;border-radius:50%;box-shadow:0 2px 4px rgba(0,0,0,.2)}[part$=pointer]::after{content:"";width:100%;height:100%;border-radius:inherit;background-color:currentColor}[role=slider]:focus [part$=pointer]{transform:translate(-50%,-50%) scale(1.1)}', Et = "[part=hue]{flex:0 0 24px;background:linear-gradient(to right,red 0,#ff0 17%,#0f0 33%,#0ff 50%,#00f 67%,#f0f 83%,red 100%)}[part=hue-pointer]{top:50%;z-index:2}", Pt = "[part=saturation]{flex-grow:1;border-color:transparent;border-bottom:12px solid #000;border-radius:8px 8px 0 0;background-image:linear-gradient(to top,#000,transparent),linear-gradient(to right,#fff,rgba(255,255,255,0));box-shadow:inset 0 0 0 1px rgba(0,0,0,.05)}[part=saturation-pointer]{z-index:3}", q = Symbol("same"), te = Symbol("color"), ke = Symbol("hsva"), se = Symbol("update"), Se = Symbol("parts"), F = Symbol("css"), W = Symbol("sliders");
let Nt = class extends HTMLElement {
  ...
  constructor() {
    super();
    const e = Ve(`<style>${this[F].join("")}</style>`), s = this.attachShadow({ mode: "open" });
    s.appendChild(e.content.cloneNode(!0)), s.addEventListener("move", this), this[Se] = this[W].map((i) => new i(s));
  }
  connectedCallback() {
  ...
  handleEvent(e) {
    const s = this[ke], i = { ...s, ...e.detail };
    this[se](i);
    let o;
    !wt(i, s) && !this[q](o = this.colorModel.fromHsva(i)) && (this[te] = o, ce(this, "color-changed", { value: o }));
  }
  [q](e) {
...
class Tt extends de {
  ...
  update(e) {
    this.hsva = e;
    const s = ee({ ...e, a: 0 }), i = ee({ ...e, a: 1 }), o = e.a * 100;
    this.style([
      {
        left: `${o}%`,
        color: ee(e)
...
const Ot = `[part=alpha]{flex:0 0 24px}[part=alpha]::after{display:block;content:"";position:absolute;top:0;left:0;right:0;bottom:0;border-radius:inherit;background-image:var(--gradient);box-shadow:inset 0 0 0 1px rgba(0,0,0,.05)}[part^=alpha]{background-color:#fff;background-image:url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity=".05"><rect x="8" width="8" height="8"/><rect y="8" width="8" height="8"/></svg>')}[part=alpha-pointer]{top:50%}`;
class Rt extends Nt {
  get [F]() {
    return [...super[F], Ot];
  }
...
const oe = {
  ...
  __addUpdatePositionEventListeners() {
    window.addEventListener("resize", this._updatePosition), this.__positionTargetAncestorRootNodes = Vt(this.positionTarget), this.__positionTargetAncestorRootNodes.forEach((s) => {
  ...
  __overlayOpenedChanged(s, i) {
    if (this.__removeUpdatePositionEventListeners(), i && (i.__overlay = null, Ee.unobserve(i), s && (this.__addUpdatePositionEventListeners(), i.__overlay = this, Ee.observe(i))), s) {
...
var Lt = Object.defineProperty, It = Object.getOwnPropertyDescriptor, P = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? It(e, s) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (o = (i ? a(e, s, o) : a(o)) || o);
  return i && o && Lt(e, s, o), o;
};
class jt extends CustomEvent {
  constructor(e) {
...
let L = class extends E {
  ...
  handleColorChange(t) {
    this.commitValue = !0, this.dispatchEvent(new jt(t.detail.value)), t.detail.close && (this.overlay.opened = !1, this.handleOverlayClose());
  }
  handleOverlayEscape() {
    this.commitValue = !1;
  }
...
customElements.whenDefined("vaadin-overlay").then(() => {
  ...
  class e extends zt(t) {
  }
  customElements.define("copilot-color-picker-overlay", e);
});
customElements.define("copilot-rgba-string-color-picker", At);
var qt = Object.defineProperty, Ht = Object.getOwnPropertyDescriptor, Dt = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? Ht(e, s) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (o = (i ? a(e, s, o) : a(o)) || o);
...
let Pe = class extends g {
  constructor() {
    super(...arguments), this.presets = new D();
  }
  static get styles() {
    return [
      g.styles,
...
var Ut = Object.defineProperty, Bt = Object.getOwnPropertyDescriptor, he = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? Bt(e, s) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (o = (i ? a(e, s, o) : a(o)) || o);
  return i && o && Ut(e, s, o), o;
};
class Ft extends CustomEvent {
  constructor(e) {
...
var Wt = Object.defineProperty, Gt = Object.getOwnPropertyDescriptor, N = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? Gt(e, s) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (o = (i ? a(e, s, o) : a(o)) || o);
  return i && o && Wt(e, s, o), o;
};
let w = class extends Ue {
  constructor() {
    super(), this.baseTheme = null, this.editedTheme = null, this.expanded = !1, this.themeEditorState = H.enabled, this.effectiveTheme = null;
  }
  static get styles() {
    return v`
      :host {
  ...
  firstUpdated() {
    this.history = new Xe(this.api), this.historyActions = this.history.allowedActions, this.undoRedoListener = (t) => {
      var s, i;
  ...
  render() {
    var t, e, s;
    return this.themeEditorState === H.missing_theme ? this.renderMissingThemeNotice() : n`
      <div class="header">
  ...
  renderPicker() {
    ...
    if ((e = this.context) != null && e.metadata) {
      const s = this.context.scope === u.local ? this.context.metadata.displayName : `All ${this.context.metadata.displayName}s`, i = n`<span class="component-type">${s}</span>`, o = this.context.scope === u.local ? Ze(this.context.component) : null, r = o ? n` <span class="instance-name-quote">"</span><span class="instance-name">${o}</span
...
var Zt = Object.defineProperty, Jt = Object.getOwnPropertyDescriptor, pe = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? Jt(e, s) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (o = (i ? a(e, s, o) : a(o)) || o);
  return i && o && Zt(e, s, o), o;
};
const Ne = window.Vaadin.devTools;
let Z = class extends Fe {
  constructor() {
    super(), this.api = new Kt(), this.handleStateEvent = (t) => {
      this.themeEditorState = t.data.state;
    }, this.handleServerEvent = (t) => {
      this.api.handleResponse(t.data);
    }, this.expanded = !0, this.themeEditorState = H.disabled;
  }
  connectedCallback() {
    super.connectedCallback(), this.onCommand(ne.state, this.handleStateEvent), this.onCommand(ne.response, this.handleServerEvent);
  }
  render() {
...
pe([
  y()
], Z.prototype, "themeEditorState", 2);
Z = pe([
...
window.Vaadin.copilotPlugins.push(Yt);
export {
  Z as CopilotThemeEditorPanel
};
